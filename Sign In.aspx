<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sign In.aspx.cs" Inherits="Factory_Automation_Integrated_System.Sign_In" %>
<!DOCTYPE html>
				...
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
						...
						<div class="login-wrap p-4 p-md-5">
							...
							<p class="text-center">Not a member? <a data-toggle="tab" href="Sign Up.aspx">Sign Up</a></p>
							<a data-toggle="tab" class="text-left" href="Sign In Manager.aspx">Admin Sign In</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						</div>
					</div>
				</div>
			</div>
