<%@ Page Title="" Language="C#" MasterPageFile="~/Manager/Manager Master.Master" AutoEventWireup="true" CodeBehind="Portfolio Page.aspx.cs" Inherits="Factory_Automation_Integrated_System.Manager.Portfolio_Page" %>
			...
			<asp:Image ID="Image1" runat="server" style="background-image: url('');" width="350px" height="211px" class="d-block mx-auto mb-4"/>
				<div class="wrap-input100 validate-input">
                            <label for="username" class="form-label">User Name
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" Font-Size="Large" ForeColor="Red"></asp:RequiredFieldValidator>
                            </label>
                <asp:TextBox ID="username" runat="server" type="text" class="form-control" placeholder="Username" Enabled="False"></asp:TextBox>
                        </div>
			      		<div class="wrap-input100 validate-input">
		            	<label for="email" class="form-label">Email
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" Font-Size="Large" ForeColor="Red"></asp:RequiredFieldValidator>
		            	</label>
              <div class="wrap-input100 validate-input">
             ...
             <asp:TextBox ID="email" runat="server" type="email" class="form-control" placeholder="you@example.com" Enabled="False"></asp:TextBox>
                        ...
                        <label for="Password" class="form-label">Password 
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" Font-Size="Large" ForeColor="Red"></asp:RequiredFieldValidator>
                        </label>
                <asp:TextBox ID="Password" runat="server" type="Password" class="form-control" placeholder="More than 6 character" TextMode="Password" Enabled="False"></asp:TextBox>
                        ...
                        <div class="wrap-input100 validate-input">
                            <asp:Label ID="Label2" runat="server" class="form-label" Visible="False"><asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="Password" ControlToValidate="TextBox1" ErrorMessage="No Matching, Retype !!" ForeColor="Maroon">No Matching, Retype !!</asp:CompareValidator></asp:Label>
                <asp:TextBox ID="TextBox1" runat="server" type="Password" class="form-control" placeholder="Conferm Password" TextMode="Password" Visible="False"></asp:TextBox>
                        </div>
