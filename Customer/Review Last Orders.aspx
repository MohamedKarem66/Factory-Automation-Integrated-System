<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/Customer Master.Master" AutoEventWireup="true" CodeBehind="Review Last Orders.aspx.cs" Inherits="Factory_Automation_Integrated_System.Customer.Review_Last_Orders" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Review Last Orders</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>Review Last Orders
            <asp:TextBox ID="TextBox1" runat="server" placeholder="Enter the Descreption of bill" class="form-control" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
    </h1>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Factory DatabaseConnectionString %>" SelectCommand="SELECT * FROM [Choose_order_online] WHERE (([order_Customer_ID] = @order_Customer_ID) AND ([order_Status] = @order_Status))">
        <SelectParameters>
            <asp:ControlParameter ControlID="Label6" Name="order_Customer_ID" PropertyName="Text" Type="Int32" />
            <asp:Parameter DefaultValue="Approved" Name="order_Status" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Factory DatabaseConnectionString %>" SelectCommand="SELECT * FROM [Choose_order_online] WHERE (([order_Customer_ID] = @order_Customer_ID) AND ([order_Status] = @order_Status) AND ([order_Descreption] LIKE '%' + @order_Descreption + '%'))">
        <SelectParameters>
            <asp:ControlParameter ControlID="Label6" Name="order_Customer_ID" PropertyName="Text" Type="Int32" />
            <asp:Parameter DefaultValue="Approved" Name="order_Status" Type="String" />
            <asp:ControlParameter ControlID="TextBox1" Name="order_Descreption" PropertyName="Text" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    <br />
