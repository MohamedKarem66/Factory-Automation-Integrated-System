<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/Customer Master.Master" AutoEventWireup="true" CodeBehind="Contact Page.aspx.cs" Inherits="Factory_Automation_Integrated_System.Customer.Contact_Page" %>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
				...
				<label class="label-input100" for="phone">Subject :
					<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" Font-Size="Large" ForeColor="Red" ControlToValidate="Subject"></asp:RequiredFieldValidator>
				</label>
