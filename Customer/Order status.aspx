<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/Customer Master.Master" AutoEventWireup="true" CodeBehind="Order status.aspx.cs" Inherits="Factory_Automation_Integrated_System.Customer.Order_status" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Factory DatabaseConnectionString %>" SelectCommand="SELECT * FROM [Choose_order_online] WHERE (([order_Customer_ID] = @order_Customer_ID) AND ([order_Descreption] LIKE '%' + @order_Descreption + '%') AND ([order_Status] = @order_Status))">
        <SelectParameters>
            <asp:ControlParameter ControlID="Label6" Name="order_Customer_ID" PropertyName="Text" Type="Int32" />
